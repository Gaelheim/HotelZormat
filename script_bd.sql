...
CREATE TABLE ClubMillas (
    HuespedId INT PRIMARY KEY,
    PuntosAcumulados INT NOT NULL DEFAULT 0,
    NochesAcumuladas INT NOT NULL DEFAULT 0,
    Rango VARCHAR(20) NOT NULL DEFAULT 'Hierro',
    CONSTRAINT FK_ClubMillas_Huesped FOREIGN KEY (HuespedId) REFERENCES Huespedes(Id) ON DELETE CASCADE
);
GO
